        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex">
            <a href="login.php" class="me-3">
              <button class="btn border-1 rounded-3 border-white login" type="submit">LOGIN</button>
            </a>
            <a href="signup.php">
              <button class="btn border-1 rounded-3 border-white sign_up" type="submit">SIGN UP</button>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="about-us" id="about">
        <div class="item-head p-5">
          ...
          <div class="item-content">
            <p class="text">
              Our mission is to inspire the next
              generation of space enthusiasts through engaging content , interactive learning ,
              and hands - on activities . Explore the
              wonders of the universe with us and
...
<div class="container  py-5 text-center">
  ...
  <div class=" text-start my-5 input-label">
    ...
    <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="Your email" name="email">
  </div>
    ...
    <div class="container">
      ...
      <div class="line"></div>
        <div class=" text-end social-icons mt-2">
          ...
          <a href="">
             <i class="fa-brands fa-linkedin ps-1"></i>
          </a>
        </div>
